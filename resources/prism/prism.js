/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+apacheconf+applescript+bash+css-extras+http+markdown+php+php-extras+sql+swift&plugins=line-highlight+line-numbers+show-invisibles+show-language+highlight-keywords */
...
Prism.hooks.add('after-highlight', function (env) {
	...
	if (clsReg.test(env.element.className))	// Remove the class "line-numbers" from the <code>
		env.element.className = env.element.className.replace(clsReg, '');
	if (!clsReg.test(pre.className)) 		// Add the class "line-numbers" to the <pre>
